        ...
        <div class="card">
            <div class="card-body login-card-body">
                <div class="login-logo">
                    <img width="100px" src="<?= site_url('assets/dist/img/kuansing.png'); ?>" style="margin: 0 auto;vertical-align:middle;" />
                </div>
                <strong><p class="login-box-msg">SISTEM PENDAFTARAN KURSUS KOMPUTER</p></strong>
